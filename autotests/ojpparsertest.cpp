...
private Q_SLOTS:
    ...
    void testParseLocations_data()
    {
        ...
        QTest::newRow("ojp2-location-by-coord")
            << s(SOURCE_DIR "/data/ojp/ch2-location-by-coord.xml")
            << s(SOURCE_DIR "/data/ojp/ch2-location-by-coord.json");
        QTest::newRow("ojp2-location-by-name")
            << s(SOURCE_DIR "/data/ojp/ch2-location-by-name.xml")
            << s(SOURCE_DIR "/data/ojp/ch2-location-by-name.json");
    }
    ...
    void testParseStopover_data()
    {
        ...
        QTest::newRow("ch2-stopover-occupancy")
            << s(SOURCE_DIR "/data/ojp/ch2-stopover-occupancy.xml")
            << s(SOURCE_DIR "/data/ojp/ch2-stopover-occupancy.json");
    }
    ...
    void testParseJourney_data()
    {
        ...
        QTest::newRow("ch2-journey-basic")
            << s(SOURCE_DIR "/data/ojp/ch2-journey-basic.xml")
            << s(SOURCE_DIR "/data/ojp/ch2-journey-basic.json");
        QTest::newRow("ch2-journey-situation")
            << s(SOURCE_DIR "/data/ojp/ch2-journey-situation.xml")
            << s(SOURCE_DIR "/data/ojp/ch2-journey-situation.json");    }
