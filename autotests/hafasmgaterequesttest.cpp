...
private Q_SLOTS:
    ...
    void testJourneyRequest_data()
    {
        ...
        QTest::newRow("arrival-with-access-mode") << req << QUrl(s("https://bvg-apps-ext.hafas.de/bin/mgate.exe"))
        ...
        QTest::newRow("line-mode-constraints") << req << QUrl(s("https://bvg-apps-ext.hafas.de/bin/mgate.exe"))
