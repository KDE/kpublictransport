    ...
    QtLocation.Map {
        ...
        Repeater {
            ...
            Repeater {
                ...
                QtLocation.MapPolyline {
                    line.width: 4
                    line.color: Kirigami.Theme.textColor
                    opacity: modelData.floorLevelChange != 0 ? 0.5 : 1.0 // TODO we want resolved absolute levels here
                    path: KPublicTransport.MapUtils.polyline(modelData);
                }
            }
        }
        Repeater {
            ...
            QtLocation.MapQuickItem {
                ...
                sourceItem: Rectangle {
                    ...
                    radius: height/2
                    border.width: 2
                    border.color: modelData.route.line.hasColor ? modelData.route.line.color : Kirigami.Theme.textColor
                    MouseArea {
                        anchors.fill: parent
                        scale: 2
