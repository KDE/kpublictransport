...
private:
    ...
    void mergeWay(const OSM::DataSet *dataSet, OSM::Way &way, const OSM::Way &otherWay) const;
    void mergeLine(const OSM::DataSet *dataSet, OSM::Way &way, const OSM::Way &otherWay) const;
    void mergeArea(const OSM::DataSet *dataSet, OSM::Way &way, const OSM::Way &otherWay) const;
